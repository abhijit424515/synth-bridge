        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6">
            ...
            <input
              ...
              id="Email"
              name="email"
              className="mt-1 w-80 pl-3 h-10 rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
            />
          </div>
          ...
          <div className="col-span-6 sm:flex sm:flex-col sm:items-left sm:gap-4 flex-col">
            ...
            <button className="mt-3 inline-block shrink-0 w-full rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
              Login
            </button>
